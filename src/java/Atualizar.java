				...
				for(FileItem item : items) {
					if(item.isFormField()) {
						...
						resp.getWriter().println("ContentType:"+item.getContentType());
                                                resp.getWriter().println("C:\\uploads" + File.separator + new Date().getTime() + "_" + item.getName());
                                                ...
                                                File uploadedFile = new File("E:\\Documentos\\NetBeansProjects\\SisLivros\\web\\"+caminho);
