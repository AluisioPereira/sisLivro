 ...
 * @author Zilderlan
 */
@WebServlet(name = "ValidarDadosUser", urlPatterns = {"/userval"})
public class ValidarDadosUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("recuperardados").include(request, response);
...
//        
//        request.setAttribute("msgemail", UsuarioDao.validarEmail(email));
    }
