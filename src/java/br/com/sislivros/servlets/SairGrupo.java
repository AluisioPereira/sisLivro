 ...
 * @author Zilderlan
 */
@WebServlet(name = "SairGrupo", urlPatterns = {"/sairGrupo"})
public class SairGrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        gGrupo.excluirUser(Integer.parseInt(request.getParameter("param")), user.getEmail());
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SairGrupo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SairGrupo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
