...
//            
        ...
        <aside class="search">
			...
			<section class="section4">  <!--  -->
                            <h3> titulo aqui</h3> 
                            <img src="img/livro6.jpeg" title="tam">
                            <div class="informations">
                                <h5> Infomações</h5>
                                <h6>Título: </h6>
                                <h6> ano: </h6>
