...
<%
    ...
    List<Livro> list = gLivros.listarTodos();
            ...
            <div class="content" >
                <nav class="menu-superior">
                    <ul >
                        ...
                        <li ><a class="inicio" href="setting.jsp" title="" >Início</a></li>
                            <%
     ...
     //            
        ...
        <article >  <!--  -->
            ...
            <section class="section1">  <!--  -->
                <a href="retornarLivro?id=<%= l.getId()%>" title=""><h3><%= l.getTitulo()%></h3></a> 
                <img src="<%= l.getFoto() %>" title="" class="tam">

                <div class="informations">
                    <h5> Infomações</h5>
                    <h6>Título: <%= l.getTitulo() %></h6>
                    <h6> ano: <%= l.getAno()%></h6>
                    <h6>Editora: <%= l.getEditora()%></h6>
                    <h6>Autores: <%= l.getAutores()%></h6>
                    <h6>Tema/Área: <%= l.getArea()%></h6>
                    <h6> ISBN: <%= l.getIsbn()%></h6>
                    <h6> Resumo: </h6>
                </div>
            </section >  <!--  -->
            <%} %>
