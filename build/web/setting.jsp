...
<html lang="PT-BR">  <!--  -->
    ...
    <body>
        ...
        <article>
            <div id="userlogado">
                <img src="${user.getPhoto()}" alt="" title="">
                <h3>${user.getName()}</h3>
            </div>
            <div class="left">
                <nav class="nav-left" id="">
                    <ul>
                        ...
                        <li><a href="#" onclick="document.getElementById('perfil-edit').style.display = 'block';" >Perfil</a></li>
                ...
                <nav class="nav-left" id="nav1">
                    <ul>
                        ...
                        <li><a href="#" onclick="document.getElementById('criarGrupo1').style.display = 'block';">Novo grupo</a></li>
                    </ul>
                </nav>
            ...
            <section >
                <div id="friends">
                    <h4>Amigos</h4>
                    <c:forEach var="listamizades" items="${listamizade}">
                        <c:if test="${listamizades.email ne user.getEmail()}">
            ...
            <section class="" id="perfil-edit" style="display: none; z-index: 2;">
            ...
            <section>
                <div id="criarGrupo1" >
                    <form action="editarGrupo?param=add&p=setting.jsp" method="post">
                        ...
                        <input type="button" id="cancelarDescricao" value="Cancelar" onclick="document.getElementById('criarGrupo1').style.display = 'none';">
                    </form>
                </div>
            </section>
            <section class="notifications style" style="display: " id="notifications">
                <a href="cancelaSolicitacao?p=setting.jsp" id="close">Fechar</a>
                <%
