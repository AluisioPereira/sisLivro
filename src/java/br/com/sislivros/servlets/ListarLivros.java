...
public class ListarLivros extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Livro> l = gl.pesquisarporNome(request.getParameter("pesquisa"));
        sessao.setAttribute("list", l);
        response.sendRedirect("PesquisaLivro.jsp");
...
//        response.sendRedirect("livro.jsp");
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListarLivros</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListarLivros at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
